  ...
  return (
    <section id="about" className="w-full px-6 md:px-10 py-24 mt-10 flex justify-center items-center relative">
      <div className="relative text-center w-full max-w-4xl px-4">
        ...
        <img className="absolute -right-4 -top-12 w-14 h-14 md:w-16 md:h-16 animate-float hidden sm:block" src={withBase("/image1.png")} alt="" aria-hidden="true" loading="lazy" />
        <img className="absolute right-12 -bottom-10 w-16 h-16 md:w-20 md:h-20 animate-float-delayed hidden sm:block" src={withBase("/image.png")} alt="" aria-hidden="true" loading="lazy" />
        <img className="absolute -bottom-16 left-12 w-16 h-16 md:w-20 md:h-20 animate-float hidden sm:block" src={withBase("/js.webp")} alt="JavaScript" loading="lazy" />
        <img className="absolute -left-6 top-8 w-16 h-16 md:w-20 md:h-20 animate-float-delayed hidden sm:block" src={withBase("/vs.png")} alt="VS Code" loading="lazy" />
